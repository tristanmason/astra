...
switch ( $component_slug ) {
	...
	case 'widget-1':
		?>
		<aside class="header-widget-area widget-area site-header-focus-item <?php echo astra_attr( 'header-widget-area-inner' ); ?>" data-section="sidebar-widgets-header-widget-1">
			<?php
	...
	case 'widget-2':
		?>
		<aside class="header-widget-area widget-area site-header-focus-item <?php echo astra_attr( 'header-widget-area-inner' ); ?>" data-section="sidebar-widgets-header-widget-2">
			<?php
			if ( is_customize_preview() && class_exists( 'Astra_Builder_UI_Controller' ) ) {
				Astra_Builder_UI_Controller::render_customizer_edit_button();
			}
