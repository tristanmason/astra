...
( function( $ ) {
	 ...
	 */
	wp.customize( 'astra-settings[responsive-display-site-title]', function( setting ) {
		setting.bind( function( logo_visibility ) {
			...
			astra_add_dynamic_css( 'responsive-display-site-title', dynamicStyle );
		} );
	} );
	 ...
	 */
	wp.customize( 'astra-settings[responsive-display-site-tagline]', function( setting ) {
		setting.bind( function( tagline_visibility ) {
			...
			astra_add_dynamic_css( 'responsive-display-site-tagline', dynamicStyle );
		} );
	} );
