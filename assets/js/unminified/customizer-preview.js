...
( function( $ ) {
	...
	// Header custom button - Font family
	...
	// Header custom button - Font Weight
	...
	// Header custom button - Font Size
	astra_responsive_font_size( 'primary-header-button-font-size]', '.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button, .ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' );

	// Header custom button - Line Height
	...
	// Header custom button - Text Transform
	...
	// Header custom button - Letter Spacing
	astra_css( 'astra-settings[primary-header-button-letter-spacing]', 'letter-spacing', '.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button, .ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' );
