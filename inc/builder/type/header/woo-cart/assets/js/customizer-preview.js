...
( function( $ ) {
	...
	astra_color_responsive_css(
		...
		'border-top-color',
		'#ast-site-header-cart .widget_shopping_cart .woocommerce-mini-cart__total, #astra-mobile-cart-drawer .widget_shopping_cart .woocommerce-mini-cart__total'
	);
	...
	// astra_css( 'astra-settings[header-woo-cart-link-color]', 'color', '' );
