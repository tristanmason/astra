...
export function astraGetResponsiveImageJs ( control ) {
    ...
    jQuery( '.customize-control-ast-responsive-image .customize-control-content .ast-image-responsive-btns li' ).removeClass( 'active' );

    jQuery( '.customize-control-ast-responsive-image .customize-control-content .ast-image-responsive-btns li.' + device ).addClass( 'active' );
