			...
			<React.Fragment>
				...
				<span className="ast-customize-control-description">
					<span className="button button-secondary ahfb-builder-hide-button ahfb-builder-tab-toggle">
						<span className="ast-builder-hide-action"> <span className="dashicons dashicons-arrow-down-alt2"></span> { __( 'Hide Builder', 'astra-builder' ) } </span>
						<span className="ast-builder-show-action"> <span className="dashicons dashicons-arrow-up-alt2"></span> { __( 'Show Builder', 'astra-builder' ) } </span>
					</span>
				</span>
			</React.Fragment>
		);
