	...
	constructor() {
		...
		let defaultParams = {
			...
			tablet: {
				'5': {
					'5-equal': {
						tooltip: __( 'Equal Width Columns', 'astra-builder' ),
						icon: 'fivecol',
					},
					'full': {
						tooltip: __( 'Collapse to Rows', 'astra-builder' ),
				...
				'4': {
					...
					'2-equal': {
						tooltip: __( 'Two Column Grid', 'astra-builder' ),
						icon: 'grid',
					},
					'full': {
						tooltip: __( 'Collapse to Rows', 'astra-builder' ),
				...
				'3': {
					...
					'3-lheavy': {
						tooltip: __( 'Left Heavy 50/25/25', 'astra-builder' ),
						icon: 'lefthalf',
					},
					'3-rheavy': {
						tooltip: __( 'Right Heavy 25/25/50', 'astra-builder' ),
						icon: 'righthalf',
					},
					'3-cheavy': {
						tooltip: __( 'Center Heavy 25/50/25', 'astra-builder' ),
						icon: 'centerhalf',
					},
					'3-cwide': {
						tooltip: __( 'Wide Center 20/60/20', 'astra-builder' ),
						icon: 'widecenter',
					},
					'3-firstrow': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'astra-builder' ),
						icon: 'firstrow',
					},
					'3-lastrow': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'astra-builder' ),
						icon: 'lastrow',
					},
					'full': {
						tooltip: __( 'Collapse to Rows', 'astra-builder' ),
				...
				'2': {
					...
					'2-lheavy': {
						tooltip: __( 'Left Heavy 66/33', 'astra-builder' ),
						icon: 'twoleftgolden',
					},
					'2-rheavy': {
						tooltip: __( 'Right Heavy 33/66', 'astra-builder' ),
						icon: 'tworightgolden',
					},
					'full': {
						tooltip: __( 'Collapse to Rows', 'astra-builder' ),
				...
				'1': {
					'full': {
						tooltip: __( 'Single Row', 'astra-builder' ),
						icon: 'row',
					},
				}
			},
