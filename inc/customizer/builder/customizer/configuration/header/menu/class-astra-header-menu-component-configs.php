	...
	class Astra_Header_Menu_Component_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			for ( $index = 1; $index <= Astra_Constants::$num_of_header_menu; $index++ ) {
				...
				$_prefix         = 'menu' . $index;
				$edit_menu_title = ( 1 === $index ) ? __( 'Primary Menu', 'astra-builder', 'astra' ) : __( 'Secondary Menu', 'astra-builder', 'astra' );
				...
				$_configs = array(
					...
					*/
					array(
						...
						'link_text' => __( 'Configure Menu from Here.', 'astra-builder', 'astra' ),
						'context'   => array(
							array(
					...
					array(
						...
						'section'   => $_section,
						'priority'  => 30,
						'title'     => __( 'Container Animation', 'astra-builder', 'astra' ),
						'choices'   => array(
							''           => __( 'Default', 'astra-builder', 'astra' ),
							'slide-down' => __( 'Slide Down', 'astra-builder', 'astra' ),
							'slide-up'   => __( 'Slide Up', 'astra-builder', 'astra' ),
					...
					array(
						...
						'linked_choices' => true,
						'priority'       => 15,
						'title'          => __( 'Container Border', 'astra-builder', 'astra' ),
						'choices'        => array(
					...
					array(
						...
						'transport' => 'postMessage',
						'default'   => '',
						'title'     => __( 'Border Color', 'astra-builder', 'astra' ),
						'section'   => $_section,
						'priority'  => 20,
						'context'   => array(
							array(
					...
					array(
						...
						'section'   => $_section,
						'priority'  => 35,
						'title'     => __( 'Item Divider', 'astra-builder', 'astra' ),
						'context'   => array(
							array(
								'setting' => 'ast_selected_tab',
								'value'   => 'general',
					...
					array(
						...
						'title'     => __( 'Divider Color', 'astra-builder', 'astra' ),
						'section'   => $_section,
						'priority'  => 40,
						'context'   => array(
							array(
				...
				if ( $is_astra_addon_active ) {
					...
					$_addon_dependent_configs = array(
						...
						array(
							...
							'section'    => $_section,
							'title'      => __( 'Link / Text Color', 'astra-builder', 'astra' ),
							'responsive' => true,
							'rgba'       => true,
							'priority'   => 7,
							'context'    => array(
						...
						array(
							...
							'control'    => 'ast-responsive-color',
							'transport'  => 'postMessage',
							'tab'        => __( 'Active', 'astra-builder', 'astra' ),
							'title'      => __( 'Link Color', 'astra-builder', 'astra' ),
							'responsive' => true,
							'rgba'       => true,
							'priority'   => 31,
						...
						array(
							...
							'type'     => 'control',
							'control'  => 'ast-heading',
							'title'    => __( 'Spacing', 'astra-builder', 'astra' ),
							'priority' => 140,
							'settings' => array(),
							'context'  => array(
								array(
						...
						array(
							...
							'section'        => $_section,
							'priority'       => 150,
							'title'          => __( 'Menu Space', 'astra-builder', 'astra' ),
							'linked_choices' => true,
						...
						array(
							...
							'section'        => $_section,
							'priority'       => 160,
							'title'          => __( 'Submenu Space', 'astra-builder', 'astra' ),
							'linked_choices' => true,
							'unit_choices'   => array( 'px', 'em', '%' ),
							'choices'        => array(
								'top'    => __( 'Top', 'astra-builder', 'astra' ),
						...
						array(
							...
							'control'        => 'ast-responsive-spacing',
							'priority'       => 170,
							'title'          => __( 'Megamenu Heading Space', 'astra-builder', 'astra' ),
							'linked_choices' => true,
							'unit_choices'   => array( 'px', 'em', '%' ),
							'section'        => $_section,
							'choices'        => array(
