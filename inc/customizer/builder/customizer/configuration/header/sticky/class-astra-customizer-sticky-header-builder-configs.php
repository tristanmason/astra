		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				array(
					...
					'type'     => 'section',
					'priority' => 100,
					'title'    => __( 'Sticky Header Builder', 'astra-builder', 'astra' ),
				...
				array(
					...
					'type'      => 'control',
					'section'   => $_section,
					'title'     => __( 'Stick Above Header', 'astra-builder', 'astra' ),
					'priority'  => 5,
					'control'   => 'checkbox',
				...
				array(
					...
					'type'      => 'control',
					'section'   => $_section,
					'title'     => __( 'Stick Primary Header', 'astra-builder', 'astra' ),
					'priority'  => 6,
					'control'   => 'checkbox',
					'transport' => 'postMessage',
					'context'   => array(
				...
				array(
					...
					'type'      => 'control',
					'section'   => $_section,
					'title'     => __( 'Stick Below Header', 'astra-builder', 'astra' ),
					'priority'  => 7,
					'control'   => 'checkbox',
					'required'  => array( 1, '==', 1 ), // ToDo: Remove this when Astra Addon option gets depricated.
					'transport' => 'postMessage',
				...
				array(
					...
					'type'     => 'control',
					'section'  => $_section,
					'title'    => __( 'Different Logo for Sticky Header?', 'astra-builder', 'astra' ),
					'priority' => 15,
					'control'  => 'checkbox',
					'context'  => array(
						array(
				...
				array(
					...
					'section'        => $_section,
					'priority'       => 15,
					'title'          => __( 'Sticky Logo', 'astra-builder', 'astra' ),
				...
				array(
					...
					'priority'    => 25,
					'title'       => __( 'Sticky Logo Width', 'astra-builder', 'astra' ),
					'input_attrs' => array(
						'min'  => 50,
						'step' => 1,
						'max'  => 600,
				...
				array(
					...
					'section'        => $_section,
					'priority'       => 20,
					'title'          => __( 'Sticky Retina Logo', 'astra-builder', 'astra' ),
					'library_filter' => array( 'gif', 'jpg', 'jpeg', 'png', 'ico' ),
				...
				array(
					...
					'type'        => 'control',
					'section'     => $_section,
					'title'       => __( 'Enable Shrink Effect', 'astra-builder', 'astra' ),
					'priority'    => 35,
					'control'     => 'checkbox',
					'description' => __( 'It will shrink the sticky header height, logo, and menu size. Sticky header will display in a compact size.', 'astra-builder', 'astra' ),
					'context'     => array(
						array(
							'setting' => 'ast_selected_tab',
							'value'   => 'general',
				...
				array(
					...
					'type'     => 'control',
					'section'  => $_section,
					'title'    => __( 'Hide When Scrolling Down', 'astra-builder', 'astra' ),
					'priority' => 35,
					'control'  => 'checkbox',
					'context'  => array(
						array(
				...
				array(
					...
					'control'  => 'ast-heading',
					'section'  => $_section,
					'title'    => __( 'Animations & Rules', 'astra-builder', 'astra' ),
					'settings' => array(),
					'priority' => 39,
					'context'  => array(
						array(
				...
				array(
					...
					'section'  => $_section,
					'priority' => 40,
					'title'    => __( 'Select Animation', 'astra-builder', 'astra' ),
					'choices'  => array(
						'none'  => __( 'None', 'astra-builder', 'astra' ),
						'slide' => __( 'Slide', 'astra-builder', 'astra' ),
						'fade'  => __( 'Fade', 'astra-builder', 'astra' ),
					),
				...
				array(
					...
					'section'  => $_section,
					'priority' => 50,
					'title'    => __( 'Enable On', 'astra-builder', 'astra' ),
					'control'  => 'select',
					'choices'  => array(
						'desktop' => __( 'Desktop', 'astra-builder', 'astra' ),
						'mobile'  => __( 'Mobile', 'astra-builder', 'astra' ),
						'both'    => __( 'Desktop + Mobile', 'astra-builder', 'astra' ),
					),
					'context'  => array(
						array(
							'setting' => 'ast_selected_tab',
				...
				array(
					...
					'control'  => 'ast-heading',
					'section'  => $_section,
					'title'    => __( 'Above Header Colors', 'astra-builder', 'astra' ),
					'settings' => array(),
					'priority' => 60,
					'context'  => array(
						array(
				...
				array(
					...
					'title'     => __( 'Header', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 60,
					'context'   => array(
				...
				array(
					...
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'title'     => __( 'Menu', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 60,
					'context'   => array(
				...
				array(
					...
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'title'     => __( 'Submenu', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 65,
					'context'   => array(
				...
				array(
					...
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'title'     => __( 'Content', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 75,
					'context'   => array(
				...
				array(
					...
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'title'     => __( 'Mega Menu Column Heading', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 70,
					'context'   => array(
				...
				array(
					...
					'control'  => 'ast-heading',
					'section'  => $_section,
					'title'    => __( 'Primary Header Colors', 'astra-builder', 'astra' ),
					'settings' => array(),
					'priority' => 80,
					'context'  => array(
						array(
				...
				array(
					...
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'title'     => __( 'Outside Item', 'astra-builder', 'astra' ),
					'section'   => $_section,
					'transport' => 'postMessage',
					'priority'  => 105,
					'context'   => array(
				...
				array(
					...
					'control'  => 'ast-heading',
					'section'  => $_section,
					'title'    => __( 'Below Header Colors', 'astra-builder', 'astra' ),
					'settings' => array(),
					'priority' => 110,
