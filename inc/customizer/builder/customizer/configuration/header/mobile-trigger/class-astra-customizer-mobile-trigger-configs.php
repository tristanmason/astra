		...
		$_configs = array(
			...
			*/
			array(
				...
				'type'     => 'section',
				'priority' => 70,
				'title'    => __( 'Trigger', 'astra-builder', 'astra' ),
			...
			array(
				...
				'section'     => $_section,
				'title'       => __( 'Icons', 'astra-builder', 'astra' ),
				'priority'    => 10,
			...
			array(
				...
				'section'   => $_section,
				'priority'  => 20,
				'title'     => __( 'Menu Label', 'astra-builder', 'astra' ),
				'type'      => 'control',
				'control'   => 'text',
				'context'   => array(
					array(
			...
			array(
				...
				'section'  => $_section,
				'title'    => __( 'Toggle Button Style', 'astra-builder', 'astra' ),
				'type'     => 'control',
				'control'  => 'select',
				'priority' => 30,
				'choices'  => array(
					'fill'    => __( 'Fill', 'astra-builder', 'astra' ),
					'outline' => __( 'Outline', 'astra-builder', 'astra' ),
					'minimal' => __( 'Minimal', 'astra-builder', 'astra' ),
				),
				'context'  => array(
					array(
						'setting' => 'ast_selected_tab',
			...
			array(
				...
				'linked_choices' => true,
				'priority'       => 60,
				'title'          => __( 'Border Width', 'astra-builder', 'astra' ),
				'choices'        => array(
			...
			array(
				...
				'control'     => 'ast-slider',
				'section'     => $_section,
				'title'       => __( 'Border Radius', 'astra-builder', 'astra' ),
				'priority'    => 70,
				'suffix'      => '',
				'transport'   => 'postMessage',
				'required'    => array(
