...
class Astra_Footer_Widget_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-footer-widget-customizer-preview-js', ASTRA_BUILDER_FOOTER_WIDGET_URI . '/assets/js/customizer-preview.js', array( 'customize-preview', 'astra-customizer-preview-js' ), ASTRA_BUILDER_VERSION, true );
