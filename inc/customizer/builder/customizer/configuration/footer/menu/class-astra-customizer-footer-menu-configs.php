		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				array(
					'name'     => $_section,
					'type'     => 'section',
					'title'    => __( 'Footer Menu', 'astra-builder', 'astra' ),
				...
				*/
				...
				array(
					...
					'choices'   => array(
						'horizontal' => __( 'Inline', 'astra-builder', 'astra' ),
						'vertical'   => __( 'Stack', 'astra-builder', 'astra' ),
					),
					'context'   => array(
						array(
							'setting' => 'ast_selected_tab',
				...
				array(
					...
					'choices'   => array(
						...
						'flex-end' => __( 'Right', 'astra-builder', 'astra' ),
					),
					'context'   => array(
						array(
							'setting' => 'ast_selected_tab',
			...
			if ( $is_astra_addon_active ) {
				...
				$_addon_dependent_configs = array(
					...
					array(
						...
						'required'  => array( ASTRA_THEME_SETTINGS . '[footer-menu-slug]', '!=', '' ),
						'title'     => __( 'Menu Color', 'astra-builder', 'astra' ),
						'section'   => $_section,
						'transport' => 'postMessage',
						'priority'  => 90,
						'context'   => array(
