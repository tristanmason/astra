...
define( 'ASTRA_HEADER_STICKY_DIR', ASTRA_THEME_DIR . 'inc/customizer/configurations/builder/header/sticky' );
define( 'ASTRA_HEADER_STICKY_URI', ASTRA_THEME_URI . 'inc/customizer/configurations/builder/header/sticky' );
