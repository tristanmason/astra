...
define( 'ASTRA_HEADER_HTML_DIR', ASTRA_THEME_DIR . 'inc/customizer/configurations/builder/header/html' );
define( 'ASTRA_HEADER_HTML_URI', ASTRA_THEME_URI . 'inc/customizer/configurations/builder/header/html' );
