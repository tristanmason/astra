...
define( 'ASTRA_HEADER_BUTTON_DIR', ASTRA_THEME_DIR . 'inc/customizer/configurations/builder/header/button' );
define( 'ASTRA_HEADER_BUTTON_URI', ASTRA_THEME_URI . 'inc/customizer/configurations/builder/header/button' );
