			...
			for ( $index = 1; $index <= $component_limit; $index++ ) {
				...
				$_configs = array(
					...
					*/
					...
					array(
						'name'       => ASTRA_THEME_SETTINGS . '[header-' . $_prefix . '-active-colors]',
						'type'       => 'control',
						'control'    => 'ast-color-group',
						'title'      => __( 'Menu Active', 'astra' ),
						'section'    => $_section,
						'transport'  => 'postMessage',
						'priority'   => 90,
						'context'    => Astra_Builder_Helper::$design_tab,
					...
					array(
						...
						'parent'     => ASTRA_THEME_SETTINGS . '[header-' . $_prefix . '-active-colors]',
						'type'       => 'sub-control',
						'section'    => $_section,
						'control'    => 'ast-responsive-color',
						'transport'  => 'postMessage',
