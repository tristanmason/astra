...
define( 'ASTRA_HEADER_MENU_DIR', ASTRA_THEME_DIR . 'inc/customizer/configurations/builder/header/menu' );
define( 'ASTRA_HEADER_MENU_URI', ASTRA_THEME_URI . 'inc/customizer/configurations/builder/header/menu' );
