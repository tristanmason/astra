								...
								<div class="background-image">
									...
									<div class="attachment-media-view background-image-upload">
										...
										<div class="actions">
											...
											<# if ( data.value['desktop']['background-image'] ) { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="up" data-id='desktop' ><span class="message"><?php esc_html_e( 'Less Settings', 'astra' ); ?></span> <span class="icon">&uarr;</span></a>
											<# } else { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="down" data-id='desktop' ><span class="message"><?php esc_html_e( 'More Settings', 'astra' ); ?></span> <span class="icon">&darr;</span></a>
											<# } #>
										</div>
									</div>
								</div>
								...
								<div class="background-image">
									...
									<div class="attachment-media-view background-image-upload">
										...
										<div class="actions">
											...
											<# if ( data.value['tablet']['background-image'] ) { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="up" data-id='tablet'><span class="message"><?php esc_html_e( 'Less Settings', 'astra' ); ?></span> <span class="icon">&uarr;</span></a>
											<# } else { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="down" data-id='tablet'><span class="message"><?php esc_html_e( 'More Settings', 'astra' ); ?></span> <span class="icon">&darr;</span></a>
											<# } #>
										</div>
									</div>
								</div>
								...
								<div class="background-image">
									...
									<div class="attachment-media-view background-image-upload">
										...
										<div class="actions">
											...
											<# if ( data.value['mobile']['background-image'] ) { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="up" data-id='mobile'><span class="message"><?php esc_html_e( 'Less Settings', 'astra' ); ?></span> <span class="icon">&uarr;</span></a>
											<# } else { #>
												<a href="<?php echo esc_url( '#' ); ?>" class="more-settings" data-direction="down" data-id='mobile'><span class="message"><?php esc_html_e( 'More Settings', 'astra' ); ?></span> <span class="icon">&darr;</span></a>
											<# } #>
										</div>
									</div>
								</div>
