...
class Astra_Icons {
	...
	public static function get_icons( $icon, $is_echo = false, $replace = false ) {
		...
		if ( true === self::is_svg_icons() ) {
			...
			if ( 'bag' === $icon ) {
				$output = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="20px" height="20px" viewBox="826 826 140 140" enable-background="new 826 826 140 140" xml:space="preserve">
