...
if ( ! class_exists( 'Astra_Theme_Options' ) ) {
	...
	class Astra_Theme_Options {
		...
		public static function defaults() {
			...
			// Updated value from "10px 40px" to "15px 30px" because it's breaking design patterm in Gutenberg,
			// and stacks multiple buttons in new line in pattern preview.
			if ( Astra_Dynamic_CSS::gutenberg_patterns_compat() ) {
				$astra_theme_defaults['theme-button-padding'] = array(
					'desktop'      => array(
						'top'    => 15,
						'right'  => 30,
						'bottom' => 15,
