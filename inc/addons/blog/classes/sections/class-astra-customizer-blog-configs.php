		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				...
				array(
					...
					'title'     => __( 'Add Space Between Posts', 'astra' ),
				...
				array(
					...
					'priority'          => 170,
					'title'             => __( 'Inside Post Spacing', 'astra' ),
					'linked_choices'    => true,
