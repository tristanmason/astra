...
( function( $ ) {
	...
	astra_color_responsive_css( 'transparent-primary-header', 'astra-settings[transparent-submenu-color-responsive]', 'color', '.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item .menu-link,.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item > .ast-menu-toggle, .ast-hfb-header.ast-theme-transparent-header [CLASS*="ast-builder-menu-"]:not( .ast-builder-menu-mobile )  .main-header-menu .sub-menu .menu-item .menu-link, .ast-hfb-header.ast-theme-transparent-header [CLASS*="ast-builder-menu-"]:not( .ast-builder-menu-mobile )  .main-header-menu .sub-menu .menu-item > .ast-menu-toggle' );
