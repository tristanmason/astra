...
( function() {
	...
	popupTriggerClick = function ( event ) {
        ...
        if ( ! document.body.classList.contains( 'ast-popup-nav-open' ) ) {
			document.body.classList.add( 'ast-popup-nav-open' );
        }
	 ...
	 */
	function submenuButtonClick ( e, $this ) {
	...
	function init( mobileHeaderType ) {
		...
		if ( 'off-canvas' === mobileHeaderType ) {
			...
			for ( var item = 0;  item < submenuButtons.length; item++ ) {
				...
				// Open the Popup when click on trigger
				submenuButtons[item].addEventListener("click", function( e ) {
					submenuButtonClick( e, this );
				});
			}
	...
	AstraToggleSetup = function () {
		...
		if (menu_toggle_all.length > 0) {
			...
			for (var i = 0; i < menu_toggle_all.length; i++) {
				...
				menu_toggle_all[i].setAttribute('data-index', i + 1);
				...
				if ('undefined' !== typeof __main_header_all[i + 1]) {

					if (document.querySelector("header.site-header").classList.contains("ast-menu-toggle-link")) {
						var astra_menu_toggle = __main_header_all[i + 1].querySelectorAll('.ast-header-break-point .main-header-menu .menu-item-has-children > .menu-link, .ast-header-break-point ul.main-header-menu .ast-menu-toggle');
					} else {
						var astra_menu_toggle = __main_header_all[i + 1].querySelectorAll('ul.main-header-menu .ast-menu-toggle');
					}
	...
	astraNavMenuToggle = function ( event ) {
		...
		if ( menu_class.indexOf('main-header-menu-toggle') !== -1 ) {
			...
			astraToggleClass(menu_toggle_all[event_index - 1 ], 'toggled');
