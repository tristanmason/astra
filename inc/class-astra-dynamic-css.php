		...
		public static function return_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$css_output = array(
				...
				self::conditional_headings_css_selectors(
					...
					'body, h1, .entry-title a, .entry-content h1, h2, .entry-content h2, h3, h4, .entry-content h4, h5, .entry-content h5, h6, .entry-content h6'
				)                                => array(
			...
			*/
			...
			if ( self::gtn_group_cover_css_comp() ) {
				...
				if ( 'no-sidebar' !== astra_page_layout() ) {
					...
					} elseif ( 'plain-container' == $container_layout ) {
					...
					if ( 'content-boxed-container' == $container_layout || 'boxed-container' == $container_layout ) {
						$parse_css .= astra_parse_css(
							array(
								...
								'.ast-no-sidebar.ast-separate-container .entry-content .wp-block-cover.alignfull' => array(
									'margin-left'   => '-6.67em',
									'margin-right'  => '-6.67em',
									'padding-left'  => '6.67em',
									'padding-right' => '6.67em',
			...
			if ( Astra_Builder_Helper::$is_header_footer_builder_active && Astra_Ext_Transparent_Header_Markup::is_transparent_header() ) {
				...
				$transparent_header_builder_desktop_css = array(
					...
					'.ast-theme-transparent-header [CLASS*="ast-header-button-"] .ast-builder-button-wrap .ast-custom-button' => array(
